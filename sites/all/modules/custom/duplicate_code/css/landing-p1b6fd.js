...
#knowledgecentre .nav-tabs > li > a .icontab.fact_must {
	background:url(../images/fact_must.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li > a .icontab.fair_advice {
	background:url(../images/fair_advice.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li > a .icontab.ceo_desk {
	background:url(../images/ceo_desk.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li.active > a .icontab.p2p, #knowledgecentre .nav-tabs > li.active > a:hover .icontab.p2p, #knowledgecentre .nav-tabs > li.active > a:focus .icontab.p2p {
	background:url(../images/p2p_active.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li.active > a .icontab.fact_must, #knowledgecentre .nav-tabs > li.active > a:hover .icontab.fact_must, #knowledgecentre .nav-tabs > li.active > a:focus .icontab.fact_must {
	background:url(../images/fact_must_active.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li.active > a .icontab.fair_advice, #knowledgecentre .nav-tabs > li.active > a:hover .icontab.fair_advice, #knowledgecentre .nav-tabs > li.active > a:focus .icontab.fair_advice {
	background:url(../images/fair_advice_active.png) top center no-repeat;
}
#knowledgecentre .nav-tabs > li.active > a .icontab.ceo_desk, #knowledgecentre .nav-tabs > li.active > a:hover .icontab.ceo_desk, #knowledgecentre .nav-tabs > li.active > a:focus .icontab.ceo_desk {
	background:url(../images/ceo_desk_active.png) top center no-repeat;
}
...
.mediacenter .mediacontent .readmore{
	float:right;
	margin-right:5px;
}
...
.knowledgelisting li:last-child{border-bottom:none;}
...
.knowledgelisting .pagination li {
    margin: 0;
}
.knowledgelisting .pagination li a{
    border:none;
}
.knowledgelisting .pagination.pull-right {
    margin-bottom: 20px;
}
.dtlcomment > a {
    margin: 5px 0 0;
...
.detail_knowledge .share-icon li {
    display: inline-block;
	 margin: 0;
	 border:none;
    padding: 0;
...
.detail_knowledge .share-icon li img {
    margin: 0 3px;
}
.share-icon ul {
    float: right;
...
#knowledgecentre .p2plist li a:hover {
    color:#2d7cbc;
}
