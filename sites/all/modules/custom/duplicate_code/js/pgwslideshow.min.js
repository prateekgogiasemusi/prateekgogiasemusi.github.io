    ...
    a.fn.pgwSlideshow = function(q) {
        ...
        var h = function(r, s) {
            ...
            if (typeof j.plugin.find(".ps-current").animate == "function") {
				...
				j.plugin.find(".ps-current > ul > li a").attr('data-target','#myModal1');
				j.plugin.find(".ps-current > ul > li a").attr('data-toggle','modal');
                //j.plugin.find(".ps-current > ul > li a").attr('data-url',dataurl);
                j.plugin.find(".ps-current > ul > li a").attr('class','slideimg');
        ...
        var g = function() {
            ...
            j.plugin.find(".ps-list > ul > li").each(function() {
                ...
                //	s.html('<img src="/sites/all/modules/custom/duplicate_code/image/video/1.jpg" alt="' + (t.title ? t.title : "") + '">')
                } else {
                    if (t.thumbnail) {
        ...
        var l = function(r, t, u) {
            var dataurl= $('.ps-list .elt_'+r+' a').attr('data-url');
            dataurl=dataurl+'?rel=0';
            var imgurl= $('.ps-list .elt_'+r+' a img').attr('src');
           j.plugin.find(".ps-current .elt_"+r+" a").attr('data-url',dataurl);
            $('#iframs').html('<iframe class="embed-responsive-item video-modal" src="'+dataurl+'" allowfullscreen=""  style="width:100%; height:310px;"></iframe>');
            if (r == j.currentSlide) {
                return false
            }
            var s = j.data[r - 1];
