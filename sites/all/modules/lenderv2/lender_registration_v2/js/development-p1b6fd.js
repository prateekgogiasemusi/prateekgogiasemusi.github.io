...
$('#ques_next-1').click(function(e){
	var rangeValue = $('#rangevalue').val();
	$('#hid_invest_amount').val(rangeValue);
});
});
...
function addressvalidation(){
	...
	else if(pincode=='' || pincode=='Select Pincode' || pincode.length!=6){
		return 0;
	}
	else{
		$('#ques_next-4').show();
...
function validateRegistration(){
	...
	if(name.length<3){
		...
		$('#fname').parent('div').append('<div class="nameerror f1"><i class="fa fa-exclamation-circle"></i></div>');
		$('#fname').parent('div').addClass('floating-label-error');
		$('#fname').parent('div').parent('div').append('<span class="redcolor f1">NAME SHOULD NOT BE BLANK.</span>');
		$('#fname').focus();
		return false;
	}
	else{
	...
	var lname = $('#lname').val();
        if(lname==''){
                ...
                $('#lname').parent('div').append('<div class="nameerror l1"><i class="fa fa-exclamation-circle"></i></div>');
                $('#lname').parent('div').addClass('floating-label-error');
                $('#lname').parent('div').parent('div').append('<span class="redcolor l1">NAME SHOULD NOT BE BLANK.</span>');
                $('#lname').focus();
                return false;
        }
        else{
            ...
            $('#lname').parent('div').addClass('floating-label-success');
            $('#lname').parent('div').append('<div class="nameerror l1"><i class="fa fa-check-circle"></i></div>');
        }
...
function send_sms_borrower() {
	...
	$('#otp').val('');
	$('.sent-otp').html('<a onclick="send_sms_borrower();"  href="javascript:void(0)"> RESEND OTP</a></span>');
...
function validateBorrowerRegistration(){
	...
	var name = $('#fname').val();
	if(name.length<3 || !name.match(namevalidate)){
		$('.nameerror').hide();
		$('#fname').parent('div').removeClass('floating-label-success');
		//$('#fname').parent('div').append('<div class="nameerror"><i class="fa fa-exclamation-circle"></i></div>');
		$('#fname').parent('div').addClass('floating-label-error error-msg');
	 ...
	 $('.nameerror').hide();
	  ...
	  $('#1name').parent('div').addClass('floating-label-success');
	var lname = $('#lname').val();
        if(lname=='' || !lname.match(namevalidate)){
                $('.nameerror').hide();
                $('#1name').parent('div').removeClass('floating-label-success');
	...
	//	$('#email_valid').parent('div').append('<div class="emailerror"><i class="fa fa-exclamation-circle"></i></div>');		
		$('#email_valid').parent('div').addClass('floating-label-error');		
		document.getElementById('email_check').innerHTML='<span class="redcolor">Please enter a valid email address</span>';	
		$('#email_valid').focus();	
		 error=1;
	}
	// hidding pass error
...
function validateBorrowerRegistrationss(){
	var error=0;
	$('#fname').parent('div').removeClass('floating-label-error');
	$('#fname').parent('div').addClass('floating-label-success');
	$('.nameerror').hide();
...
function validatefname(value){
	value = value.replace(" ", "");
	var namevalidate = /^[a-zA-Z ]*$/;
	if(value=='' || !value.match(namevalidate)){
		$('#ques_next-5').fadeOut("slow");
	}
	else{
		$('#hid_father_name').val(value);
		$('#ques_next-5').fadeIn("slow");
	}
}
